...
%prep
%setup -q -n openldap-2.4.49
cd %{_builddir}/openldap-2.4.49
%patch1 -p1
...
cp %{_builddir}/openldap-2.4.49/build/LICENSE-2.0.1 %{buildroot}/usr/share/package-licenses/openldap/09fc2e9f527fcb0d594bc658d21e42d3a5124b83
cp %{_builddir}/openldap-2.4.49/libraries/liblmdb/LICENSE %{buildroot}/usr/share/package-licenses/openldap/bc06cbdf781c87d2df2fe385214f936d010dd2a2
cp %{_builddir}/openldap-2.4.49/libraries/librewrite/Copyright %{buildroot}/usr/share/package-licenses/openldap/0da054d8429802e25641decec43d4fbc1fbe4f2f
%make_install
...
/usr/libexec/openldap/back_perl-2.4.so.2.10.12
/usr/libexec/openldap/back_perl.so

%files lib
%defattr(-,root,root,-)
/usr/lib64/liblber-2.4.so.2
/usr/lib64/liblber-2.4.so.2.10.12
/usr/lib64/libldap-2.4.so.2
/usr/lib64/libldap-2.4.so.2.10.12
