...
%prep
%setup -q -n openldap-2.4.58
cd %{_builddir}/openldap-2.4.58
%patch1 -p1
...
cp %{_builddir}/openldap-2.4.58/LICENSE %{buildroot}/usr/share/package-licenses/openldap/bc06cbdf781c87d2df2fe385214f936d010dd2a2
cp %{_builddir}/openldap-2.4.58/build/LICENSE-2.0.1 %{buildroot}/usr/share/package-licenses/openldap/09fc2e9f527fcb0d594bc658d21e42d3a5124b83
cp %{_builddir}/openldap-2.4.58/libraries/liblmdb/LICENSE %{buildroot}/usr/share/package-licenses/openldap/bc06cbdf781c87d2df2fe385214f936d010dd2a2
cp %{_builddir}/openldap-2.4.58/libraries/librewrite/Copyright %{buildroot}/usr/share/package-licenses/openldap/0da054d8429802e25641decec43d4fbc1fbe4f2f
%make_install
