...
Source0  : https://www.openldap.org/software/download/OpenLDAP/openldap-release/openldap-2.6.9.tgz
Source1  : openldap.tmpfiles
Source2  : https://www.openldap.org/software/download/OpenLDAP/openldap-release/openldap-2.6.9.tgz.asc
...
%setup -q -n openldap-2.6.9
cd %{_builddir}/openldap-2.6.9
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a openldap-2.6.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739286925
