...
Source0  : https://www.openldap.org/software/download/OpenLDAP/openldap-release/openldap-2.4.53.tgz
...
%prep
%setup -q -n openldap-2.4.53
cd %{_builddir}/openldap-2.4.53
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601054814
...
cp %{_builddir}/openldap-2.4.53/LICENSE %{buildroot}/usr/share/package-licenses/openldap/bc06cbdf781c87d2df2fe385214f936d010dd2a2
cp %{_builddir}/openldap-2.4.53/build/LICENSE-2.0.1 %{buildroot}/usr/share/package-licenses/openldap/09fc2e9f527fcb0d594bc658d21e42d3a5124b83
cp %{_builddir}/openldap-2.4.53/libraries/liblmdb/LICENSE %{buildroot}/usr/share/package-licenses/openldap/bc06cbdf781c87d2df2fe385214f936d010dd2a2
cp %{_builddir}/openldap-2.4.53/libraries/librewrite/Copyright %{buildroot}/usr/share/package-licenses/openldap/0da054d8429802e25641decec43d4fbc1fbe4f2f
%make_install
